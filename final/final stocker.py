import json
with open('/Users/ashmitsingh/Documents/1.scodehacker/final/data_stocker.json', 'r') as openfile:
    # Reading from json file
    use_data = json.load(openfile)

if type(use_data)!=str:
    main_data = use_data['LMT']
    lame_i=(main_data)
else:
    lame_i=(use_data)
print(lame_i)
...
def stockPredict(ticker2):
    ...
    plt.legend()
    plt.grid(True)
    x.savefig('/Users/ashmitsingh/Documents/1.scodehacker/final/LMT_1.png')
    print("filesaved")
...
if predicted>0:
    trule={headline_v3: 'POS'}
elif predicted<0:
    trule={headline_v3: 'NEG'}
else:
    trule={headline_v3: 'NEU'}

json_object = json.dumps(trule, indent=0)
 
# Writing to sample.json
with open("/Users/ashmitsingh/Documents/1.scodehacker/final/sample_stock.json", "w") as outfile:
